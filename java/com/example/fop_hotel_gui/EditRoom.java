...
public class EditRoom extends database implements Initializable {
    ...
    public void AlterRoom(ActionEvent actionEvent)throws IOException{
        Parent root= FXMLLoader.load(getClass().getResource("AlterRoom.fxml"));
        Scene scene=new Scene(root);
        Stage primaryStage=new Stage();
